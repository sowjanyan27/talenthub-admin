        ...
        <div className="border-b border-[#ddd] pb-1">
          <div className="flex gap-3 m-2 mt-3">
            <button
              ...
              className={`flex-1 px-6 py-3 text-[0.92rem] font-medium rounded-3xl transition-colors ${activeTab === 'details'
            ...
            <button
              ...
              className={`flex-1 px-6 py-3 text-[0.92rem] font-medium rounded-3xl transition-colors ${activeTab === 'screening'
                  ? 'bg-[linear-gradient(to_right,#3B82F6,#2563EB)] text-white'
                  : 'hover:bg-gray-200 text-gray-500 hover:text-gray-700'
                }`}
            >
